script 0-current_working_directory prints the current directory you are working from
...
school.mgc magic file that can be used with command file to detect school data files. School data files always contain the string SCHOOL at offset 0.
